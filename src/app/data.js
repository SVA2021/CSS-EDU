    ...
    AnimationSelectors: { // need to fill
        part1: {
            properties: [
                ...
                { id: 7, name: `color`, initValue: `white`, finalValue: `orange` },
                { id: 8, name: `columns`, initValue: `1`, finalValue: `5` },
                { id: 9, name: `font`, initValue: `14px normal`, finalValue: `32px bold` },
                { id: 10, name: `height`, initValue: `100px`, finalValue: `250px` },
                { id: 20, name: `width`, initValue: `100px`, finalValue: `500px` },
                { id: 11, name: `letterSpacing`, initValue: `2px`, finalValue: `20px` },
                ...
                { id: 15, name: `maxHeight`, initValue: `50px`, finalValue: `150px` },
                { id: 16, name: `minHeight`, initValue: `750px`, finalValue: `50px` },
                { id: 17, name: `maxWidth`, initValue: `250px`, finalValue: `500px` },
                { id: 18, name: `minWidth`, initValue: `750px`, finalValue: `50px` },
