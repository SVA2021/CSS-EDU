...
import { normalizeObjText, isEmpty } from '../../app/functionStore';
...
const DemoCSSFeatures = (props) => {
    ...
    if (Object.keys(activeDemoStatus)[0] === 'filter') return <ImageFilter />;
    // if (Object.keys(activeDemoStatus)[0] === 'gradient') return ImageFilter;
